...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        if (Utils.readContentsAsString(story).equals("")) {
            Utils.writeContents(story, args[1]);
            System.out.println(Utils.readContentsAsString(story));
            return;
        }
        String past = Utils.readContentsAsString(story) + "\n";
        Utils.writeContents(story, past, args[1]);
        System.out.println(Utils.readContentsAsString(story));
    }
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        Dog bdayDog = Dog.fromFile(args[1]);
        bdayDog.haveBirthday();
        Utils.writeObject(Utils.join(CAPERS_FOLDER, "dogs/" + args[1]), bdayDog);
    }
