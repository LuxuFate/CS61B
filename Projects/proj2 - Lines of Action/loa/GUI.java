...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Help->Game Information", this::help);
        addMenuButton("Undo->Undo", this::undo);
        addMenuButton("Manual->Black", this::manBlack);
        addMenuButton("Manual->White", this::manWhite);
    ...
    private void help(String dummy) {
        displayText("Help Page", HELP_TEXT);
    }
